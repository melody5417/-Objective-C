...
{
    return (QCAppDelegate *) [UIApplication sharedApplication].delegate;
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController   *vcContent = [[QCViewController alloc] initWithNibName:@"QCViewController"
                                                                       bundle:nil];
    self.rootViewController = [[[UINavigationController alloc] initWithRootViewController:vcContent]
                               autorelease];
    [vcContent release];
