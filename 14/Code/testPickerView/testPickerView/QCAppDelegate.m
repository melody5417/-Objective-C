...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    QCRootViewController *rootViewController = [[QCRootViewController alloc] initWithNibName:@"QCRootViewController"
                                                                                      bundle:nil];
    //将一个导航控制器作为根视图
	QCNavControllerViewController *aNavigationController = [[[QCNavControllerViewController alloc] initWithRootViewController:rootViewController]
                                                            autorelease];
