...
//  testKeyboard
//
//  Created by Jason Qian on 10/5/12.
...
typedef NSUInteger (^BlockType)(NSUInteger);
...
{    
    ...
    self.viewController = [[[QCViewController alloc] initWithNibName:@"QCViewController" bundle:nil] autorelease];
