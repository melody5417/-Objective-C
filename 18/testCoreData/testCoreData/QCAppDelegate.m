...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //以导航控制器展示表视图，考虑到需要在导航栏上加几个编辑用的按钮
    QCSimpleTableViewController   *simpleTVC  = [[[QCSimpleTableViewController alloc] initWithStyle:UITableViewStylePlain]
                                                 autorelease];
    QCNavigationController          *aNavVC     = [[[QCNavigationController alloc] initWithRootViewController:simpleTVC]
                                                   autorelease];
    self.window.rootViewController = aNavVC;
